...
const LanguageDropdown = ({ settings, saveSettings }: Props) => {
  ...
  const handleLangItemClick = (lang: 'en' | 'ru' | 'uk') => {
  ...
  return (
    <Fragment>
      ...
      >
        <MenuItem
          sx={{ py: 2 }}
          selected={i18n.language.split('-')[0] === 'en'}
          onClick={() => {
        ...
        <MenuItem
          sx={{ py: 2 }}
          selected={i18n.language.split('-')[0] === 'ru'}
          onClick={() => {
        ...
        {/* <MenuItem
          sx={{ py: 2 }}
          selected={i18n.language.split('-')[0] === 'uk'}
          onClick={() => {
            handleLangItemClick('uk')
            saveSettings({ ...settings, direction: 'ltr' })
          }}
        >
          Ukrainian
