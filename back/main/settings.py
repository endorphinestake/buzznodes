...
GRAFANA_DASHBOARD_UID = env.str("GRAFANA_DASHBOARD_UID")
GRAFANA_PANEL_UPTIME_ID = env.int("GRAFANA_PANEL_UPTIME_ID")
GRAFANA_PANEL_VOTING_POWER_ID = env.int("GRAFANA_PANEL_VOTING_POWER_ID")
GRAFANA_PANEL_COMISSION_ID = env.int("GRAFANA_PANEL_COMISSION_ID")
