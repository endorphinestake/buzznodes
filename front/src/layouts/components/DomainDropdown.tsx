        ...
        {Object.entries(domains)
          .filter(
            ([domainName]) =>
              ...
              (domain.includes("althea") && domainName.includes("althea")) ||
              (domain.includes("haqq") && domainName.includes("haqq")) ||
              (domain.includes("provenance") && domainName.includes("provenance"))
            )
